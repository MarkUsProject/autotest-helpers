from coverage_analysis import get_coverage_dict, make_coverage_fixture

import example_tests

coverage_fixture = make_coverage_fixture(example_tests, ['buggy_function.py'])


class TestGetCoverageDict:
    def test_replacement(self):
        """Test get_coverage_dict with replacements made"""
        cd = get_coverage_dict(example_tests, ['correct_function.py'],
    ...
    def test_no_replacement(self):
        ...
        cd = get_coverage_dict(example_tests, ['buggy_function.py'])
